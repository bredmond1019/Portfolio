...
@api.route("/word_of_the_day", methods=["GET", "OPTIONS"])
def get_word():
...
[
    ...
    {
        "class": "verbo transitivo direto",
        "meanings": [
            "Fazer o desenho de; criar de maneira gráfica; desenhar: descreveu a figura geométrica.",
            "Representar a trajetória de: as cargas elétricas descrevem ondas eletromagnéticas.",
            "[Gramática] Particípio Irregular: descrito.",
        ],
        "etymology": "Etimologia (origem da palavra descrever). Do latim describere.",
    },
]
